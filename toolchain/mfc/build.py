...
TARGETS: typing.List[MFCTarget] = [
    ...
    MFCTarget('simulation',    ['-DMFC_SIMULATION=ON'],    False, True,  MFCTarget.Dependencies([], [], [])),
    MFCTarget('post_process',  ['-DMFC_POST_PROCESS=ON'],  False, True,  MFCTarget.Dependencies(['silo'], [], [])),
